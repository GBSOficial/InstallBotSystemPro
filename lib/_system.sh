...
sudo su - deploy <<EOF
  git clone -b main https://GBSOficial:${token_code}@github.com/GBSOficial/BotSystemBeta.git /home/deploy/${instancia_add}
EOF
...
deletar_tudo() {
  print_banner
  printf "${WHITE} 💻 Vamos deletar o BotSystem...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_bloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos bloquear o BotSystem...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_desbloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos Desbloquear o BotSystem...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_dominio() {
  print_banner
  printf "${WHITE} 💻 Vamos Alterar os Dominios do BotSystem...${GRAY_LIGHT}"
  printf "\n\n"
